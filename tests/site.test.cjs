...
test("card previews focus on the actual game objects",()=>{assert.match(html,/class="tower-figure"/);assert.match(html,/wissensturm-tower\.png/);assert.match(html,/bowling-lane-card\.jpg/)});
